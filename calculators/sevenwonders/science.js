...
const calc = (ele) => {
  ...
  score.value = getScore(rulesV, stoneV, gearsV)
  rulesP.innerHTML = '+' + (getScore(rulesV+1, stoneV, gearsV) - score.value)
  stoneP.innerHTML = '+' + (getScore(rulesV, stoneV+1, gearsV) - score.value)
  gearsP.innerHTML = '+' + (getScore(rulesV, stoneV, gearsV+1) - score.value)
}
